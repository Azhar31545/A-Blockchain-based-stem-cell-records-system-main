...
//         return (
//             <Layout>
//                 <Segment padded><h1>Hospital Registration</h1></Segment>
//                 <Segment>
...
//                             <label>Address</label>
//                             <Input 
//                                 placeholder = 'Eg. Plot No. 32-34, Knowledge Park III, Greater Noida'
//                                 label={{ basic: true }}
//                                 labelPosition='right'
...
//                     {/* <br/> */}
//                     <h2 style={{ marginTop: '20px', marginBottom: '30px'}}></h2>
//                     <Divider clearing />                    
//                     <Form.Group widths='equal'>
//                         <Form.Field>
//                             <label>Speciality</label>
//                             <Input 
//                                 placeholder = 'Eg. Anatomy,Physiotherapy'
...
const allergyOptions = [
    { key: 'f', text: 'hPSCreg', value: 'Food' },
    { key: 'm', text: 'SKIP', value: 'Medical' },
    { key: 'e', text: 'RIKEN BRC', value: 'Environmental' },
    { key: 'o', text: 'Others', value: 'Others' },
]

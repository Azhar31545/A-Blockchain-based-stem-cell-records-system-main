...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Header
      as='h1'
      content='Blockchain Stem Cell Records System'
      inverted
      style={{
          ...
          >
            <Menu size='large' inverted>
              ...
              <Menu.Menu position='right'>
                 ...
                 */}
                <Dropdown item text='Stem Cell'>
                  <Dropdown.Menu>
                    <Dropdown.Item>
                      <Link route='/'>
                        <a style={{color:'black'}} onClick={this.onClickedPatient}>View Detail</a>
                      </Link>
                    </Dropdown.Item>
                    <Dropdown.Item>
                      <Link route='/edit-patient'>
                        <a style={{color:'black'}}>Edit Detail</a>
                      </Link>
                    </Dropdown.Item>
                    <Dropdown.Item>
...
const HomepageLayout = () => (
  <ResponsiveContainer>
      ...
      <Grid container stackable verticalAlign='middle'>
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <Header as='h3' style={{ fontSize: '2em' }}>
              We Make Blockchain Stem cell Record Systems
            </Header>
            <p style={{ fontSize: '1.33em' }}>
    ...
    <Segment style={{ padding: '8em 0em' }} vertical>
      <Container text>
        <Header as='h3' style={{ fontSize: '2em' }}>
          Major Issue with Stem Cell Record Systems
        </Header>
        <p style={{ fontSize: '1.33em' }}>
        ...
        <Header as='h3' style={{ fontSize: '2em' }}>
          Is Blockchain the best step forward for stem cell Record Systems?
        </Header>
        <p style={{ fontSize: '1.33em' }}>
          ...
          <Grid.Row>
            ...
            <Grid.Column width={3}>
              ...
              <List link inverted>
                ...
                <List.Item as='a'>Store Stem Cell Record</List.Item>
...
//     <Header
//       as='h1'
//       content='Blockchain Stem Cells Record System'
//       inverted
//       style={{
//         fontSize: mobile ? '2em' : '4em',
//         fontWeight: 'normal',
...
//                 <Dropdown item text='Store'>
//                   <Dropdown.Menu>
                   
                    
//                     <Dropdown.Item>
//                       <Link route='/make-appointment'>
//                         <a style={{color:'black'}}>Enter Details</a>
//                       </Link>
//                     </Dropdown.Item>
...
//                     <Dropdown.Item>
//                       <Link route='/'>
//                         <a style={{color:'black'}} onClick={this.onClickedPatient}>View Details</a>
//                       </Link>
//                     </Dropdown.Item>
